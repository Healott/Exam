...
function addRow () {
  document.querySelector('#content').insertAdjacentHTML(
    'afterbegin',
        ...
        <table border=1>
        <tr>
        <td><input type="text" name="name" value="" placeholder="Student Surname" class="txt" id="asf"/></td>
  ...
  document.querySelector('#contentt').insertAdjacentHTML(
    'afterbegin',
        ...
        <td><select class="year">
                ...
                <option value="saab">Bulisig - 2022122901</option>
                <option value="saab">Shem - 2022122902</option>
                <option value="saab">Plaza - 2022122903</option>
                <option value="saab">Salazar - 2022122904</option>
                <option value="saab">Dela-Cruz - 2022122905</option>
              </optgroup>

            </select></td>
        <td><select class="year">
                <option disabled selected>Course</option>
                <option value="saab">CPE101L</option>
                <option value="saab">MATH161</option>
                <option value="saab">CPE107L</option>
              </optgroup>
        ...
        <td><select class="year">
                ...
                <option value="saab">1.25</option>
                <option value="saab">1.5</option>
                <option value="saab">1.75</option>
                <option value="saab">2.0</option>
                <option value="saab">2.25</option>
                <option value="saab">2.5</option>
                <option value="saab">2.75</option>
                <option value="saab">3.0</option>
                <option value="saab">5.0</option>
              </optgroup>
